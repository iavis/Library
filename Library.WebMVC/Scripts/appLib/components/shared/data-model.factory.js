...
(function (app) {
    ...
    app.factory('dataModelFactory', dataModelFactory);

    dataModelFactory.$inject = ['$filter', 'beginningFactory'];

    function dataModelFactory($filter, beginningFactory) {
        ...
        function factory(source) {
            ...
            var _events = (function () {
                return {
                    ...
                    /*  */
                    beforeChangeAdditions: function () { },
                    afterChangeAdditions: function () { }
                ...
                if (isArray(beginnings)) {
                    ...
                    for (var i = 0; i < alphabets.length; i++) {
                        ...
                        alphabet.forEach(function (word /* letter or digit */) {
                            beginWords.push(new beginningFactory(word, letters.countOf(word)));
                        });
            ...
            function getAdditions() {
                var value = _data.additions;
                return isObject(value) ? value : {};
            }

            function setAdditions(additions) {
                _events.beforeChangeAdditions();
                _data.additions = isObject(additions) ? additions : {};
                _events.afterChangeAdditions();
            }
