    ...
    $scope.getData = function () {
        ...
        .then(function (response) {
            ...
            $scope.authorTable = new $TableJS.dataGridView(
                ...
                [
                    { name: 'firstName', vname: 'Имя', isVisible: true },
                    { name: 'middleName', vname: 'Среднее имя / Отчество', isVisible: true },
                    { name: 'lastName', vname: 'Фамилия', isVisible: true }
                ],
                undefined,
                undefined
                );
            ...
            $scope.bookTable = new $TableJS.dataGridView(
                $scope.books,
                undefined,
                [{ name: 'name', vname: 'Название', isVisible: true },
                    { name: 'pageCount', vname: 'Кол-во страниц', isVisible: true },
                    { name: 'year', vname: 'Год выпуска', isVisible: true }
                ],
                undefined,
                undefined,
