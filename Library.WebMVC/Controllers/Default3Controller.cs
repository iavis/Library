...
namespace Library.WebMVC.Controllers
{
    public class Default3Controller : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include="Id,Name,PageCount,Year,Isbn10,Isbn13,Photo,PublisherId")] Book book)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include="Id,Name,PageCount,Year,Isbn10,Isbn13,Photo,PublisherId")] Book book)
        {
            if (ModelState.IsValid)
            {
